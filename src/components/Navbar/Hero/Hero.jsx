...
export const Hero = () => {
  return <section className={styles.container}>
    ...
    <p className={styles.description}>I'm a full-stack developer with a few months of experience using React and NodeJS. Reach out if you'd like to learn more!</p>
